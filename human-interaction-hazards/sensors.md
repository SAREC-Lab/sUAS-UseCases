...
### <sub> [![](human-interaction-hazards/icons/e-icon.PNG)](#) SX1: The UAV hovers in the sky and is unresponsive to operator commands
...
### <sub> [![](human-interaction-hazards/icons/e-icon.PNG)](#) SX2: The UAV flies out of control and does not respond to operator commands
| Hazard addressed | Context | Solution |
|:--|:--|:--|
...
### <sub> [![](human-interaction-hazards/icons/s-icon.PNG)](#) SX3: The operator is not immediately aware that hardware has failed
| Hazard addressed | Context | Solution |
|:--|:--|:--|
...
### <sub> [![](human-interaction-hazards/icons/e-icon.PNG)](#) SX4: The operator is unable to evaluate the severity of the geolocation problem and/or resolve the situation.
| Hazard addressed | Context | Solution |
|:--|:--|:--|
...
### <sub> [![](human-interaction-hazards/icons/s-icon.PNG)](#) SX5: The operator loses track of the UAV's geolocation
| Hazard addressed | Context | Solution |
|:--|:--|:--|
...
### <sub> [![](human-interaction-hazards/icons/s-icon.PNG)](#) SX6: The camera that provides video stream and supports onboard vision becomes unavailable to the operator when they need it to support the mission
| Hazard addressed | Context | Solution |
|:--|:--|:--|
